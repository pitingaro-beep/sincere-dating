...
| カテゴリ | 内容 |
|---|---|
| **表示バグ** | `---`・リンク・見出し・テーブル・画像の描画確認 |
| **校閲** | 誤字・脱字・送り仮名・句読点の確認 |
| **文体統一** | 「まい」の一人称・です/ます統一・読者への語りかけ調 |
| **事実確認** | アプリ料金・機能説明・統計データの正確性 |
| **表現チェック** | 不自然な日本語・回りくどい表現・過剰な主張がないか |
| **景品表示法** | 誇大表現・根拠のない断定・ステルスマーケティングがないか |
| **UX改善提案** | 画像追加・見出し構成・内部リンク・CTA誘導の提案 |
